...
```bash
cat /home/ec2-user/environment/eks-cluster-upgrades-reference-arch/gitops/applications/01-sample-app.yaml | grep nodeSelector -A5
```
...
Let's uncomment line `5` of the newly created file  `/home/ec2-user/environment/eks-cluster-upgrades-reference-arch/gitops/add-ons/kustomization.yaml`. 

```bash
sed -i "5s/# //g" /home/ec2-user/environment/eks-cluster-upgrades-reference-arch/gitops/add-ons/kustomization.yaml  
```
