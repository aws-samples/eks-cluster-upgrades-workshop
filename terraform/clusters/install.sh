...
sed -i '' "s|ARGO_WORKFLOWS_BUCKET_NAME|$argo_workflows_bucket_name|g" "$karpenter_file"
sed -i '' "s|ARGO_WORKFLOWS_IRSA|$argo_workflows_irsa|g" "$karpenter_file"
sed -i '' "s|CLUSTER_ENDPOINT|$cluster_endpoint|g" "$karpenter_file"
sed -i '' "s|KARPENTER_INSTANCE_PROFILE|$karpenter_instance_profile|g" "$karpenter_file"
sed -i '' "s|KARPENTER_IRSA|$karpenter_irsa|g" "$karpenter_file"
sed -i '' "s|AWS_REGION|$aws_region|g" "$karpenter_file"

sed -i '' "s|ARGO_WORKFLOWS_BUCKET_ARN|$argo_workflows_bucket_arn|g" "$argo_workflows_file"
sed -i '' "s|ARGO_WORKFLOWS_BUCKET_NAME|$argo_workflows_bucket_name|g" "$argo_workflows_file"
sed -i '' "s|ARGO_WORKFLOWS_IRSA|$argo_workflows_irsa|g" "$argo_workflows_file"
sed -i '' "s|CLUSTER_ENDPOINT|$cluster_endpoint|g" "$argo_workflows_file"
sed -i '' "s|KARPENTER_INSTANCE_PROFILE|$karpenter_instance_profile|g" "$argo_workflows_file"
sed -i '' "s|KARPENTER_IRSA|$karpenter_irsa|g" "$argo_workflows_file"
sed -i '' "s|AWS_REGION|$aws_region|g" "$argo_workflows_file"

sed -i '' "s|AWS_VPC_ID|$aws_vpc_id|g" "$upgrades_workflow_file"
